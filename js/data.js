...
const Q = [
    ...
    ["0-3",  900,  900,   900,   250,   0,    50,   0,    50,   720], //E??? R???
    ...
    ["3-4",  0,    0,     300,   300,   35,   40,   0,    0,    300], //T??? E???
    ...
    ["5-3",  800,  400,   400,   0,     0,    60,   0,    0,    240],
    ["5-4",  100,  0,     0,     700,   40,   0,    0,    0,    420],
    ["6-1",  300,  300,   0,     100,   0,    0,    0,    0,    120],
    ["6-2",  0,    200,   550,   100,   0,    0,    30,   70,   180], //P???
    ["6-3",  0,    0,     200,   500,   0,    60,   0,    0,    300], //E???
    ["6-4",  800,  800,   800,   0,     0,    0,    0,    0,    720],
    ["7-1",  650,  0,     650,   0,     0,    0,    0,    0,    150],
    ["7-2",  0,    650,   0,     300,   75,   0,    0,    25,   240],
    ["7-3",  900,  600,   600,   0,     0,    50,   0,    0,    330],
    ["7-4",  250,  250,   250,   600,   0,    0,    90,   0,    480],
    ["8-1",  150,  150,   150,   0,     0,    30,   0,    0,    60],
    ["8-2",  0,    0,     0,     450,   0,    0,    0,    80,   180],
    ["8-3",  400,  800,   800,   0,     0,    0,    50,   50,   360], //P??? R???
    ["8-4",  1500, 400,   400,   100,   80,   0,    0,    0,    540],
    ["9-1",  0,    0,     100,   50,    0,    0,    0,    0,    30],
    ["9-2",  180,  0,     180,   100,   0,    0,    30,   0,    90],
    ["9-3",  750,  750,   0,     0,     80,   0,    0,    0,    270], //T???
    ["9-4",  500,  900,   900,   0,     0,    100,  0,    0,    420],
    ["10-1", 140,  200,   0,     0,     0,    0,    0,    0,    40],
    ["10-2", 0,    240,   180,   0,     70,   0,    30,   0,    100],
    ["10-3", 0,    480,   480,   300,   0,    0,    60,   40,   320], //P??? R???
    ["10-4", 660,  660,   660,   330,   0,    50,   0,    0,    600], //E???(12/10)60%
    ["11-1", 350,  1050,  0,     0,     60,   40,   0,    0,    240],
    ["11-2", 360,  540,   540,   0,     100,  0,    0,    0,    240], //T???
    ["11-3", 0,    750,   1500,  250,   0,    0,    0,    50,   480], //R???(10/7)60%
    ["11-4", 0,    1650,  0,     900,   0,    0,    100,  0,    600],
    ["12-1", 0,    220,   220,   0,     0,    55,   0,    0,    60],
    ["12-2", 360,  0,     0,     120,   0,    0,    0,    0,    90],
    ["12-3", 800,  1200,  1200,  0,     0,    0,    100,  0,    540],
    ["12-4", 1800, 0,     1800,  0,     100,  0,    0,    0,    720],
    ["13-1", 0,    0,     1200,  0,     0,    0,    100,   0,    180],
    ["13-2", 800,  800,   800,   300,   0,    0,    0,    0,    360],
    ["13-3", 0,    4000,  0,     1200,  0,    100,   0,    0,    1440],
    ["13-4", 0,    0,     0,     1000,  100,   0,    0,    0,    360]
];
