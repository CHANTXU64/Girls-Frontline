...
function Q_init_Contract() {
    ...
    Q[44][5] = 8 / 16 / Q[44][9];//???//11-1
    Q[45][5] = 12 / 12 / Q[45][9];//???//11-2
    ...
    Q[43][6] = 10 / 12 / Q[43][9];//???//10-4
    Q[44][6] = 8 / 16 / Q[44][9];//???//11-1
    ...
    Q[10][7] = 0.125;//2-3
    Q[19][7] = 0.125;//4-4
    Q[42][7] = 0.3 / Q[42][9];//10-3
    Q[47][7] = 14 / 14 / Q[47][9];//???//11-4
    Q[25][7] = 0.2 / Q[25][9];//6-2
    Q[31][7] = 0.8 / Q[31][9];//7-4
    Q[34][7] = 0.6 / Q[34][9];//8-3
    Q[41][7] = 0.25 / Q[41][9];//10-2
    //快修 Quick Restoration Contract
    Q[0][8] = 0.5 / Q[0][9];//0-1
    Q[2][8] = 0.4 / Q[2][9];//0-3
    Q[6][8] = 0.6 / Q[6][9];//1-3
    Q[9][8] = 0.3 / Q[9][9];//2-2
    Q[10][8] = 0.5 / Q[10][9];//2-3
    Q[14][8] = 0.5 / Q[14][9];//3-3
    Q[18][8] = 6 / 14 / Q[18][9];//???//4-3
    Q[21][8] = 0.8 / Q[21][9];//5-2
    Q[25][8] = 0.5 / Q[25][9];//6-2
    Q[29][8] = 0.3 / Q[29][9];//7-2
    Q[33][8] = 0.8 / Q[33][9];//8-2
    Q[34][8] = 0.3 / Q[34][9];//8-3
    Q[42][8] = 0.5 / Q[42][9];//10-3
    Q[46][8] = 7 / 10 / Q[46][9];//11-3
}
