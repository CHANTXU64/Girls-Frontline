...
const language_zh_CN = {
    ...
    HTML: {
        ...
        header: "后勤组合排序器 ",
        Config_text: "全局数据",
        warn_ancient_browser: "你的浏览器似乎已经过时，很多功能无法使用，请使用最新的Chrome或Firefox浏览器。",
        ...
        setTarget_saved_dropdown: "自定义需求量",
        setTarget_noSaved: "无自定义需求量",
        setTarget_saved_button: "保存",
        ...
        consumption_saved_dropdown: "自定义",
        consumption_noSaved: "无自定义内容",
        consumption_saved_button: "保存",
        Consumption_reset: "清零",
        Consumption_times_label: "每日执行次数",
        Consumption_add: "添加",
        consumption_times_th: "次数",
        consumption_action_th: "操作",
    ...
    JS: {
        ...
        PC_ranking_alert2: "由于需求量比例不恰当或方案设置等原因导致没有排序结果。",
        PC_ranking_alert3_1: "由于需求量比例不恰当或方案设置等原因导致",
        PC_ranking_alert3_2: "个后勤方案没有排序结果。",
        resource: "资源量",
        contract: "契约量",
        delete_: "删除",
        apply: "应用",
        ...
        C_preset_23: "插板建造",
        C_preset_24: "夜视仪建造",
        consumption_total_td: "单日总计",
        PC_changeStart_prompt_1: "输入新的开始日期",
        PC_changeStart_prompt_2: "更改开始日期",
        PC_changeStart_prompt_3: "请输入正确的开始日期。",
        PC_changeStart_prompt_4: "开始日期应该小于结束日期。",
        PC_changeEnd_prompt_1: "输入新的结束日期",
        PC_changeEnd_prompt_2: "更改结束日期",
        PC_changeEnd_prompt_3: "请输入正确的结束日期。",
        PC_changeEnd_prompt_4: "结束日期应该大于开始日期。",
        plzInputTargetName: "请输入自定义需求量名称",
        TargetSaved_prompt_title: "自定义需求量名称",
        TargetSaved_invalidNameFeedback1: "请填入名称。",
        TargetSaved_invalidNameFeedback2: "名称太长了。",
        plzInputConsumptionName: "请输入自定义的名称",
        ConsumptionSaved_prompt_title: "自定义的名称",
    },
    html_class: {
        Manp: "人力",
        Ammu: "弹药",
...
const language_zh_TW = {
    ...
    HTML: {
        ...
        header: "後勤組合排序器 ",
        Config_text: "全局數據",
        warn_ancient_browser: "你的瀏覽器似乎已經過時，很多功能無法使用，請使用最新的Chrome或Firefox瀏覽器。",
        ...
        setTarget_saved_dropdown: "自定義需求量",
        setTarget_noSaved: "無自定義需求量",
        setTarget_saved_button: "保存",
        ...
        consumption_saved_dropdown: "自定義",
        consumption_noSaved: "無自定義內容",
        consumption_saved_button: "保存",
        Consumption_reset: "清零",
    ...
    JS: {
        ...
        PC_ranking_done: "排序完成！",
        PC_ranking_alert2: "由於需求量比例不恰當或方案設置等原因導致沒有排序結果。",
        PC_ranking_alert3_1: "由於需求量比例不恰當或方案設置等原因導致",
        PC_ranking_alert3_2: "個後勤方案沒有排序結果。",
        resource: "資源量",
        contract: "契約量",
        delete_: "刪除",
        apply: "應用",
        ...
        C_preset_23: "插板建造",
        C_preset_24: "夜視儀建造",
        consumption_total_td: "單日總計",
        PC_changeStart_prompt_1: "輸入新的開始日期",
        PC_changeStart_prompt_2: "更改開始日期",
        PC_changeStart_prompt_3: "請輸入正確的開始日期。",
        PC_changeStart_prompt_4: "開始日期應該小於結束日期。",
        PC_changeEnd_prompt_1: "輸入新的結束日期",
        PC_changeEnd_prompt_2: "更改結束日期",
        PC_changeEnd_prompt_3: "請輸入正確的結束日期。",
        PC_changeEnd_prompt_4: "結束日期應該大於開始日期。",
        plzInputTargetName: "請輸入自定義需求量名稱",
        TargetSaved_prompt_title: "自定義需求量名稱",
        TargetSaved_invalidNameFeedback1: "請填入名稱。",
        TargetSaved_invalidNameFeedback2: "名稱太長了。",
        plzInputConsumptionName: "請輸入自定義的名稱",
        ConsumptionSaved_prompt_title: "自定義的名稱",
    },
    html_class: {
        Manp: "人力",
        Ammu: "彈藥",
...
const language_en = {
    ...
    HTML: {
        ...
        warn_ancient_browser: "Your browser seems to be outdated and many functions are not available. Please use the latest Chrome or Firefox browser.",
        ...
        setTarget_saved_dropdown: "Custom Demand",
        setTarget_noSaved: "No custom demand",
        setTarget_saved_button: "Save",
        ...
        consumption_saved_dropdown: "Custom",
        consumption_noSaved: "No custom content",
        consumption_saved_button: "Save",
        Consumption_reset: "Clear",
        Consumption_times_label: "Number of daily executions",
        Consumption_add: "Add",
        consumption_times_th: "Times",
        consumption_action_th: "Action",
    ...
    JS: {
        ...
        PC_ranking_alert2: "There are no ranking results due to inappropriate demand ratio or plan setting.",
        PC_ranking_alert3_1: " Due to inappropriate demand ratio or plan setting, the ",
        PC_ranking_alert3_2: " logistics plans have no ranking results.",
        resource: "Resources",
        contract: "Contracts",
        delete_: "Delete",
        apply: "Apply",
        ...
        C_preset_16: "Production Sights",
        C_preset_17: "Production Cloak, Suppressor",
        C_preset_18: "Production Exoskeleton",
        C_preset_19: "Production Hollow Point Ammo",
        C_preset_20: "Production High Velocity Ammo",
        C_preset_21: "Production Armor Piercing Ammo",
        C_preset_22: "Production Ammunition Box",
        C_preset_23: "Production Armor Plate",
        C_preset_24: "Production Night Vision Equipment",
        consumption_total_td: "Single-day Total",
        PC_changeStart_prompt_1: "Enter new start date",
        PC_changeStart_prompt_2: "Change start date",
        PC_changeStart_prompt_3: "Please enter the correct start date.",
        PC_changeStart_prompt_4: "The start date should be less than the end date.",
        PC_changeEnd_prompt_1: "Enter new end date",
        PC_changeEnd_prompt_2: "Change end date",
        PC_changeEnd_prompt_3: "Please enter the correct end date.",
        PC_changeEnd_prompt_4: "The end date should be greater than the start date.",
        plzInputTargetName: "Please enter a custom demand name",
        TargetSaved_prompt_title: "Custom Demand Name",
        TargetSaved_invalidNameFeedback1: "Please provide a name.",
        TargetSaved_invalidNameFeedback2: "The name is too long.",
        plzInputConsumptionName: "Please enter a custom name",
        ConsumptionSaved_prompt_title: "Custom Name",
    },
    html_class: {
        Manp: "Mpwr",
        Ammu: "Ammo",
